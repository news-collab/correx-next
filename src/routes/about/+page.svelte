...
<div class="docs-container">
  ...
  <p>
    Correx is based on several notions: First, we believe that forthright corrections are a
    fundamental, essential part of journalistic transparency. Second, we can help automate the
    process of sending them down those social media pathways -- to alert people who'd shared the
    original articles that there was a correction or significant update. Finally, we hope to help
    the news industry (and others who believe in the best journalistic principles) come up with a
    standard for creating and publishing corrections.
  </p>
  ...
  <p>
    Correx collects a minimal amount of personal information which is described in our <a
